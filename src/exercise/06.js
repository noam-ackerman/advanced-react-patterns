...
function useToggle({
  ...
  React.useEffect(() => {
    warning(!(!hasOnChange && onIsControlled && !readOnly), "Something is wrong! 'on' prop with a value was sent to useToggle without an onChange function, please add onChange function or set a readOnly attribute")
